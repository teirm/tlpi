...
main(int argc, char *argv[])
{
    ...
    /* 
     * establish handler for most signals but mask all other signals during handler
     * execution to prevent handlers recursively interrupting each other.
     */
     ...
     * set to us before they are unblocked and handled.
     */
